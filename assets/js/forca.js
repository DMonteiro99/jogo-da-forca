...
let botaoNovoJogoSumido = document.getElementById("btn-novo-jogo").style.display = "none"
let btnSairSumir = document.getElementById("btn-sair").style.display = "none"
...
var palavras = ["ALURA", "FORCA", "HTML", "ORACLE", "LOGICA", "PROGRAMA", "DESAFIO", "JAVA", "PHP", "PYTHON", "RUBY", "CSS"]
...
function iniciarJogo() {
    ...
    // chama a função que desenha o canvas
    desenharCanvas()
